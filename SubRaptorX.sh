...
╚══════╝ ╚═════╝ ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝        ╚═╝    ╚═════╝ ╚═╝  ╚═╝${reset} ${red}██╔╝   ██╗  ${reset} ${white} ╚══════╝╚═╝ ╚═════╝ 
                                                                          ${reset} ${red} ╚═╝    ╚═╝ ${reset}            
"   
    echo -e "                                     🔍 ${bold}${green} Subdomain Enumeration Tool ${reset} ${bold}${cyan}🔍                                        ${reset}"

    echo -e "                                              ${white}Built by ${bold}${red}0xarshad ${reset}"
...
# End Function
    ...
    echo -e "${blue}===============${cyan}Thank you for using ${white}SubRaptor${red}X${blue}================${reset}"
}
...
find_subdomains() {
    ...
    read -p "${cyan}🔗 Enter the Domain Name (eg: test.com):${reset} " dom
    ...
    sort -u final.txt > ${dom}_live_subs.txt
    ...
    cat ${dom}_live_subs.txt

    echo -e "${blue}-------------------------------------------------------------${reset}"

    echo -e "${green}✅ Results saved in ${red}${dom}_live_subs.txt${reset}"

    

    # Cleanup temporary files

    rm -f assetfinder_subs.txt subfinder_subs.txt wayback_subs.txt all_subs.txt live_subs_httprobe.txt live_subs_curl.txt final.txt all_subs-end.txt
